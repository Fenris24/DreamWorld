...
public class DarklingAnimation
{
    ...
    boolean play;
    public DarklingAnimation()
    {
        AssetManager assets = AssetManager.getInstance();
        idle = new Animation(assets.getEntity("Darkling_Idle"), 9, Const.tileSize * 2, Const.tileSize * 2, 3);
        getHit = new Animation(assets.getEntity("Darkling_Hit"), 5, Const.tileSize * 2, Const.tileSize * 2, 3);
        run = new Animation(assets.getEntity("Darkling_Run"), 6, Const.tileSize * 2, Const.tileSize * 2, 3);
        attack = new Animation(assets.getEntity("Darkling_Attack"), 12, Const.tileSize * 2, Const.tileSize * 2, 3);
        death = new Animation(assets.getEntity("Darkling_Death"), 23, Const.tileSize * 2, Const.tileSize * 2, 3);
    ...
    public void draw(Graphics2D g2d, Event e, int pozX, int pozY)
    {
        ...
        else if(e.isAttacking)
        {
            ...
            e.isAttacking = !currentAnimation.draw(g2d, pozX, pozY, true, 6, e.orientation);
        }
        else if(e.inSight)
        {
            play = true;
